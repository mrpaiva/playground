...
| CSS strategy | **Rewrite the card/row rules in `SessionRail.css`; keep lines 1-95** (rail, header, new button, warning, list, empty) | Handoff §3 marks header and warning unchanged; rewriting them would risk regressions in the one part of the rail nobody asked to change |
