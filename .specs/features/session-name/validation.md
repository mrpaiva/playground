...
| T6: Rail rows by name | `e5cc36a` | ✅ COMPLETE — 9 tests, 59 existing unmodified | ✅ `rail-groups.test.ts` 59 → 68 (+9), 0 removed lines; RAIL-12/13 amended with the AD-022 note |
